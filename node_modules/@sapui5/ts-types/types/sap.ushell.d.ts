 ...
 */
    ...
    namespace ui {
      ...
      namespace bookmark {
        ...
        class ContentNodeTreeItem extends sap.m.StandardTreeItem {
          ...
          static extend<T extends Record<string, unknown>>(
             ...
             */
            oClassInfo?: T &
              ThisType<T & sap.ushell.ui.bookmark.ContentNodeTreeItem>,
            /**
             * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
             * used by this class
             */
      ...
      namespace launchpad {
        namespace section {
          ...
          class CompactArea extends sap.ui.core.Control {
            ...
            static extend<T extends Record<string, unknown>>(
               ...
               */
              oClassInfo?: T &
                ThisType<T & sap.ushell.ui.launchpad.section.CompactArea>,
              /**
               * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
               * used by this class
               */
        ...
        class LinkTileWrapper extends sap.ui.core.Control {
          ...
          static extend<T extends Record<string, unknown>>(
             ...
             */
            oClassInfo?: T &
              ThisType<T & sap.ushell.ui.launchpad.LinkTileWrapper>,
            /**
             * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
             * used by this class
             */
        ...
        class TileState extends sap.ui.core.Control {
          ...
          static extend<T extends Record<string, unknown>>(
             ...
             * Object literal with information about the class
             */
            oClassInfo?: T & ThisType<T & sap.ushell.ui.launchpad.TileState>,
            /**
             * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
             * used by this class
             */
        ...
        class VizInstanceLink extends sap.m.GenericTile {
          ...
          static extend<T extends Record<string, unknown>>(
             ...
             */
            oClassInfo?: T &
              ThisType<T & sap.ushell.ui.launchpad.VizInstanceLink>,
            /**
             * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
             * used by this class
             */
      ...
      interface $ContentNodeSelectorSettings
        extends sap.ui.core.$XMLCompositeSettings {
      ...
      class ContentNodeSelector extends sap.ui.core.XMLComposite {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: T & ThisType<T & sap.ushell.ui.ContentNodeSelector>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
