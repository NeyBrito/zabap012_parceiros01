    ...
    namespace navigation {
      ...
      class NavError extends sap.ui.base.Object {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           */
          oClassInfo?: T & ThisType<T & sap.fe.navigation.NavError>,
          /**
      ...
      class NavigationHandler extends sap.ui.base.Object {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: T & ThisType<T & sap.fe.navigation.NavigationHandler>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
        ...
        static navigate(
          ...
          sNavMode?: string,
          /**
           * Parameter used to defined if the app is on sticky mode.
           */
          bIsStickyEditMode?: boolean
        ): void;
        /**
      ...
      class PresentationVariant extends sap.ui.base.Object {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: T & ThisType<T & sap.fe.navigation.PresentationVariant>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
      ...
      class SelectionVariant extends sap.ui.base.Object {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: T & ThisType<T & sap.fe.navigation.SelectionVariant>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
