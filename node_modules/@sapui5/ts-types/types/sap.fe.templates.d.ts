    ...
    namespace templates {
      namespace ListReport {
        ...
        class ExtensionAPI extends sap.fe.templates.ExtensionAPI {
          ...
          static extend<T extends Record<string, unknown>>(
             ...
             */
            oClassInfo?: T &
              ThisType<T & sap.fe.templates.ListReport.ExtensionAPI>,
            /**
      ...
      namespace ObjectPage {
        ...
        class ExtensionAPI extends sap.fe.templates.ExtensionAPI {
          ...
          static extend<T extends Record<string, unknown>>(
             ...
             */
            oClassInfo?: T &
              ThisType<T & sap.fe.templates.ObjectPage.ExtensionAPI>,
            /**
             * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
             * used by this class
             */
      ...
      class ExtensionAPI extends sap.ui.base.Object {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: T & ThisType<T & sap.fe.templates.ExtensionAPI>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
