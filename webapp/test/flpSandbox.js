		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#z012parceiros-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"z012parceiros-display": {
								"semanticObject": "z012parceiros",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z012.parceiros",
									"url": sap.ui.require.toUrl("z012/parceiros")
								}
							}
						}
					}
